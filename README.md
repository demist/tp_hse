...
Задача скрипта - "обойти" `входную директорию` и сохранить все файлы из нее (и из всех сложенных директорий) в `выходную директорию` - но уже без иерархии, а просто все файлы - внутри `выходной директории`.
...
| :---: | :---: | :---: | :---: | :---: |
| 1 | 0, 1, 2 | Основы Python | *Установить необходимое ПО для курса на свои машины* | |
| 2 | 3, 4 | Базовые инструменты разработки ПО | **ТЗ1**: Пишем простую программу на Python | |
| 3 | 5, 6 | Инструменты отладки | | |
| 4 | 7, 8 | Тестирование ПО | **ТЗ2**: Добавляем тесты и разворачиваем простейший CI/CD | **ТЗ1**: Пишем простую программу на Python |
