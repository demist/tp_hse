...
| 1 | Этапы развития проекта | | | |
| 2 | Базовые понятия о языках программирования | | | |
| 3 | Основные диаграммы UML | | | |
| 4 | CI/CD/CD | | | |
| 5 | Отладка ПО, ч.1: работа с ошибками ПО | | | |
| 6 | Отладка ПО, ч.2: техники отладки | | | |
| 7 | Управление качеством ПО, ч.1 | | | |
| 8 | Управление качеством ПО, ч.2 | | | |
| 9 | Принципы проектирования ПО, ч.1 | | | |
| 10 | Принципы проектирования ПО, ч.2 | | | |
