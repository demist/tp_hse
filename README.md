...
| :---: | :---: | :---: | :---: | :---: |
| 1 | Организационное + Этапы развития проекта + Базовые понятия о языках программирования | Основы Python | Пишем простую программу на Python | |
| 2 | Основные диаграммы UML + CI/CD/CD | Базовые инструменты разработки ПО | | |
| 3 | Отладка ПО, ч.1: работа с ошибками ПО + Отладка ПО, ч.2: техники отладки | Инструменты отладки | | |
| 4 | Управление качеством ПО, ч.1 + Управление качеством ПО, ч.2 | Тестирование ПО | Добавляем тесты и разворачиваем простейший CI/CD | Пишем простую программу на Python |
| 5 | Принципы проектирования ПО, часть 1 + Принципы проектирования ПО, часть 2 | Диаграммы UML | Проектируем небольшое приложение по требованиям | |
| 6 | Архитектурные паттерны + Методологии разработки ПО | Практика проектирования | | Добавляем тесты и разворачиваем простейший CI/CD |
| 7 | *сессия* | *сессия* | | Проектируем небольшое приложение по требованиям |
