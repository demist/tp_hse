...
| :---: | :---: | :---: | :---: | :---: |
| :fire: 1 | Организационное + Этапы развития проекта + Базовые понятия о языках программирования | Основы Python | *Установить необходимое ПО для курса на свои машины* | |
