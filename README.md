...
Обратите внимание, что *ФИО* может быть неполное (например, только *ФИ*, или только *Имя*), *номер телефона* и/или *адрес электронной почты* может быть не заполнен.
...
- `2 балла` Реализован поиск и вывод на экран всех контактов, у которых незаполнен *номер телефона* и/или *адрес электронной почты*
