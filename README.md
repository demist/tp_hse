...
Для успешного выполнения практики на **Семинаре №2** вам понадобятся следующие инструменты, доступны разные варианты (выберите один из них): 

- Если у вас *Windows*, варианты:
	- Поставить себе **Linux** - наиболее удобный способ, если у вас *Windows*
	...
	- Установить себе WSL (*Windows Subsystem for Linux*) - если у вас *Windows*
